"""
Django settings for djangoJSONTEST project.
...
SECRET_KEY = 'django-insecure-j8n-&^p%g1(3eln+$@s97w+y2ss8cd9@tg*svs-xfp@&ygf_h4'
...
ROOT_URLCONF = 'djangoJSONTEST.urls'
...
WSGI_APPLICATION = 'djangoJSONTEST.wsgi.application'
